package com.example.mapractical3
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        ...
        val clickableViews: List<View> =
            listOf(boxOneText, boxTwoText, box_three_text, box_four_text, box_five_text, rootConstraintLayout, redButton, greenButton, yellowButton)
